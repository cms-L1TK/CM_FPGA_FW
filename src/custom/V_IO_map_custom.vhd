...
begin  -- architecture behavioral
    ...
    if localRdReq = '1' then
      ...
      case to_integer(unsigned(localAddress(9 downto 0))) is
        ...
        when 773 => --0x305
          ...
          localRdData(13 downto  8)  <=  reg_data(773)(13 downto  8);           --
          localRdData(21 downto 16)  <=  reg_data(773)(21 downto 16);           --
  ...
  Ctrl.TCRAM.ENA                    <=  reg_data(773)(13 downto  8);     
  Ctrl.TCRAM.ENB                    <=  reg_data(773)(21 downto 16);     
  ...
  begin  -- process reg_writes
    if reset_axi_n = '0' then                 -- asynchronous reset (active low)
      reg_data( 0)( 5)  <= DEFAULT_V_IO_CTRL_t.C2C.STATUS.INITIALIZE;
      reg_data( 4)(22)  <= DEFAULT_V_IO_CTRL_t.C2C.DEBUG.EYESCAN_RESET;
      reg_data( 4)(23)  <= DEFAULT_V_IO_CTRL_t.C2C.DEBUG.EYESCAN_TRIGGER;
      reg_data( 5)(15 downto  0)  <= DEFAULT_V_IO_CTRL_t.C2C.DEBUG.PCS_RSV_DIN;
      reg_data( 6)(12)  <= DEFAULT_V_IO_CTRL_t.C2C.DEBUG.RX.BUF_RESET;
      reg_data( 6)(13)  <= DEFAULT_V_IO_CTRL_t.C2C.DEBUG.RX.CDR_HOLD;
      reg_data( 6)(17)  <= DEFAULT_V_IO_CTRL_t.C2C.DEBUG.RX.DFE_LPM_RESET;
      reg_data( 6)(18)  <= DEFAULT_V_IO_CTRL_t.C2C.DEBUG.RX.LPM_EN;
      reg_data( 6)(23)  <= DEFAULT_V_IO_CTRL_t.C2C.DEBUG.RX.PCS_RESET;
      reg_data( 6)(24)  <= DEFAULT_V_IO_CTRL_t.C2C.DEBUG.RX.PMA_RESET;
      reg_data( 6)(25)  <= DEFAULT_V_IO_CTRL_t.C2C.DEBUG.RX.PRBS_CNT_RST;
      reg_data( 6)(29 downto 26)  <= DEFAULT_V_IO_CTRL_t.C2C.DEBUG.RX.PRBS_SEL;
      reg_data( 7)( 2 downto  0)  <= DEFAULT_V_IO_CTRL_t.C2C.DEBUG.RX.RATE;
      reg_data( 8)( 7)  <= DEFAULT_V_IO_CTRL_t.C2C.DEBUG.TX.INHIBIT;
      reg_data( 8)(15)  <= DEFAULT_V_IO_CTRL_t.C2C.DEBUG.TX.PCS_RESET;
      reg_data( 8)(16)  <= DEFAULT_V_IO_CTRL_t.C2C.DEBUG.TX.PMA_RESET;
      reg_data( 8)(17)  <= DEFAULT_V_IO_CTRL_t.C2C.DEBUG.TX.POLARITY;
      reg_data( 8)(22 downto 18)  <= DEFAULT_V_IO_CTRL_t.C2C.DEBUG.TX.POST_CURSOR;
      reg_data( 8)(23)  <= DEFAULT_V_IO_CTRL_t.C2C.DEBUG.TX.PRBS_FORCE_ERR;
      reg_data( 8)(31 downto 27)  <= DEFAULT_V_IO_CTRL_t.C2C.DEBUG.TX.PRE_CURSOR;
      reg_data( 9)( 3 downto  0)  <= DEFAULT_V_IO_CTRL_t.C2C.DEBUG.TX.PRBS_SEL;
      reg_data( 9)( 8 downto  4)  <= DEFAULT_V_IO_CTRL_t.C2C.DEBUG.TX.DIFF_CTRL;
      ...
      reg_data(773)(13 downto  8)  <= DEFAULT_V_IO_CTRL_t.TCRAM.ENA;
      reg_data(773)(21 downto 16)  <= DEFAULT_V_IO_CTRL_t.TCRAM.ENB;
      ...
      if localWrEn = '1' then
        ...
        when 773 => --0x305
          ...
          reg_data(773)(13 downto  8)  <=  localWrData(13 downto  8);      --
          reg_data(773)(21 downto 16)  <=  localWrData(21 downto 16);      --
